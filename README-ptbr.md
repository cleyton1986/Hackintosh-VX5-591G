...
```
.
├── README.md                ← visão geral (Inglês — padrão)
...
Se este projeto foi útil para você e quer apoiar o desenvolvimento, considere me pagar um café:
...
Qualquer contribuição é voluntária e muito bem-vinda! Ajuda a manter o projeto vivo e motiva novas funcionalidades.
...
**Este software é fornecido "como está", sem garantia de qualquer tipo.** Hackintosh é para fins de estudo/teste — use por sua conta e risco.
